		...
		<li class="replyLi" data-rv_num={{rv_num}} style="clear:both;margin-bottom:27px;">
            ...
            <div class="timeline-item" style="border:1px solid lightgray;padding: 11px;">
                ...
                <h3 class="timeline-header">
					<strong style="color: orangered;">{{checkRating rv_score}} 
					<p class='rv_score' style="display:none;">{{rv_score}}</p></strong> 
					</h3>
									...
									<p id="soldOut" style="font-size: 15px; font-weight: 600; color: red;display: none;text-align: left;"> - 품절상품 - </p>
										...
										<div>
											<form method="get" action="/order/buy" id="orderForm">
												...
												<input class="onlyNumber" type="number" id="ord_amount" name="ord_amount" value="1" style="width: 77px;font-size: 13px; height: 24px; float: left;padding-bottom: 4px; padding-left: 5px;"/><br><br>
										...
										<!-- 상품 후기 리스트 -->
									 	<ul class="timeline" style="padding:0;">
											...
											<li class="time-label" id="repliesDiv" >
												...
												<button id="repliesDivBtn" type="button" class="btn btn-secondary" style="float: right;background-color: lightgray;color: white;border-color: lightgray;font-size: 11px;">
