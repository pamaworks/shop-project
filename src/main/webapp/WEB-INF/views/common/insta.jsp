...
<head>
    ...
    <style>
        ...
        #instagram {overflow: hidden; margin:0 auto; text-align: center;margin-bottom: 55px;}
        .instagram_item {float: center;width: 180px;padding-right: 1px; padding-bottom: 1px;display:inline-block;}
        .instagram_item > a {display: inline-block;width: 100%;padding-top: 100%;position: relative;background: no-repeat center center;background-size: cover;}
        ...
        .instagram_item p {width: 100%;padding: 19px 57px;position: absolute;left: 0;top: 50%;font-size: 13px;font-weight: 300;text-align: left;color: #fff;transform: translateY(-50%);z-index: 2;opacity: 0;-webkit-transition: opacity .55s cubic-bezier(.215,.61,.355,1);transition: opacity .55s cubic-bezier(.215,.61,.355,1);}
...
<body>
    ...
    <script>
        ...
        var token = "IGQVJVRWY0aGo3RVRZAWTFHUzM5blN2cXJyekJpcmxRaUpTTWxfSDB2bjN3RHJlNWhpOXZAiOGxvUUFkRmV2U1FmTmpvTnpyRUVpQmxwd3pNZAUQtaTU5YjZAQSDd0SDJKeHZAQbHBVaEt2YlBILWk4VHVhSAZDZD";
